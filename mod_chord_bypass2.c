...
//const char *dev = "/dev/input/by-path/pci-0000:00:14.0-usb-0:1.4:1.0-event-kbd";
char* dev = NULL; //"/dev/input/by-path/pci-0000:00:14.0-usb-0:3.4:1.0-event-kbd";
...
/*
   ...
   echo $devices[1];
*/
//const char* chooseDevice = "ls /dev/input/by-id/ | grep --regexp \"usb-HID_Keyboard_HID_Keyboard\" | sort > /home/mio/.kbd_dev_name.txt";
...
int main(int argc, char** argv)
{
   ...
   //    size_t len = 0;
   //    ssize_t read;
   //    fp = fopen("/home/mio/.kbd_dev_name.txt", "r");
   //    if (fp == NULL) exit(EXIT_FAILURE);
   //    while ((read = getline(&dev, &len, fp)) != -1)
   //    {
   ...
   if(1 > argc) 
   {
      printf("you need to specify a device as an argument (located in /dev/input/by-id/)");
      return -1;
   }
