...
static const std::array<ChordMap, 20> cm = {{
    { "su -P -c \"export DISPLAY=:0; xdotool type 'Ü'\" mio"              , {kn_capslock, kn_A, kn_S}, 2, kn_U, keyPressed, true },
    { "su -P -c \"export DISPLAY=:0; xdotool type 'Ö'\" mio"              , {kn_capslock, kn_A, kn_S}, 2, kn_Y, keyPressed, true },
    { "su -P -c \"export DISPLAY=:0; xdotool type 'Ä'\" mio"              , {kn_capslock, kn_A, kn_S}, 2, kn_H, keyPressed, true },
    ...
    { "su -P -c \"export DISPLAY=:0; xdotool key 'Alt+Shift+0x002f'\" mio", {kn_capslock}, 0, kn_up_slash },
    ...
    { "su -P -c \"export DISPLAY=:0; xdotool key 'Page_Down'\" mio"       , {kn_capslock}, 0, kn_H },
    { "su -P -c \"export DISPLAY=:0; i3-msg focus down\" mio"             , {kn_capslock, kn_A}, 0, kn_N, true },
    { "su -P -c \"export DISPLAY=:0; i3-msg focus left\" mio"             , {kn_capslock}, 0, kn_N },
