...
struct ChordMap
{
   ...
   unsigned short mod_key[255] = {0}; // which mod keys need to be pressed
   ...
   unsigned short virtual_keys[255] = {0}; // which virtual keys should be pressed
...
// set this if you're RDP'd into some machine
// #define PASSTHROUGH_MODE

// set this if you're RDP'd into some machine and you want to switch workspaces like normal (CAPSLOCK+Q, CAPSLOCK+D)
// #define WINDOWS_MODE
...
// { nullptr, {KEY_CAPSLOCK}, 1, KEY_SPACE, keyReleased, true, {KEY_LEFTCTRL, KEY_LEFTALT, KEY_SPACE }, 1 },
   { "su -c \"export DISPLAY=:0; sleep 0.1; xdotool keydown 'ctrl'; xdotool keydown 'alt'; xdotool keydown 'space';xdotool keyup 'ctrl'; xdotool keyup 'alt'; xdotool keyup 'space'\" mio" , {KEY_CAPSLOCK}, 1, KEY_SPACE, keyReleased, false },
   { "su -c \"export DISPLAY=:0; i3-msg mode 'Move: J·↓ K·↑ H·← L·→  [Q]uit'\" mio", {KEY_CAPSLOCK}, 1, KEY_LEFTBRACE, keyReleased, false },
// { nullptr, {KEY_CAPSLOCK}, 1, KEY_LEFTBRACE, keyReleased, true, {KEY_CAPSLOCK, KEY_M}, 2 },
